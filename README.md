...
__The SysAuditTool Project !!!__
==

Description
----
The __SysAuditTool project__ is an open source application used to __retrieve lots of passwords__ stored on a local computer. 
...
<p align="center"><img src="https://user-images.githubusercontent.com/10668373/43320585-3e34c124-91a9-11e8-9ebc-d8eabafd8ac5.png" alt="The SysAuditTool project"></p>
...
Standalones
----
Standalones are now available here: https://github.com/AlessandroZ/SysAuditTool/releases/
...
```
audit_check.exe browsers
```

* Launch only a specific software script
```
audit_check.exe browsers -firefox
```

* Write all passwords found into a file (-oN for Normal txt, -oJ for Json, -oA for All).
Note: If you have problems to parse JSON results written as a multi-line strings, check [this](https://github.com/AlessandroZ/SysAuditTool/issues/226). 
```
audit_check.exe all -oN
audit_check.exe all -oA -output C:\Users\test\Desktop
```

* Get help
```
audit_check.exe -h
audit_check.exe browsers -h
```


* Change verbosity mode (2 different levels)
```
audit_check.exe all -vv
```

* Quiet mode (nothing will be printed on the standard output)
```
audit_check.exe all -quiet -oA
```
...
```
audit_check.exe all -password ZapataVive
```
...
```
audit_check all --password SuperSecurePassword
```
...
* Using Pyinstaller
```
pyinstaller --additional-hooks-dir=. -F --onefile audit_check.py
```
* Using Nuitka
```
python3 -m nuitka --standalone --onefile --include-package=audit_lib audit_check.py
```

For developers
----
Please refer to the wiki before opening an issue to understand how to compile the project or to develop a new module.
https://github.com/AlessandroZ/SysAuditTool/wiki

Donation
----
If you want to support my work doing a donation, I will appreciate a lot:
* Via BTC: 16zJ9wTXU4f1qfMLiWvdY3woUHtEBxyriu
* Via Paypal: https://www.paypal.me/audit_libproject
...
* All [contributors](https://github.com/AlessandroZ/SysAuditTool/graphs/contributors) who help me on this project
